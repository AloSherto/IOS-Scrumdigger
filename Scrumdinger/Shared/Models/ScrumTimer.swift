...
//  Scrumdinger (iOS)
//
//  Created by Alessa De Leon Chavez on 2022-04-05.
//

import Foundation
/// keeps time for daily scrum meeting. keep track of the total meeting time, the for each speaker, and the name of the current speaker.
class ScrumTimer: ObservableObject {
    /// A struct to keep tfack of meeting attendees during a meeting.
    struct Speaker: Identifiable {
        /// The attende name.
        let name: String
        /// True if the attendee has completed their turn to speak.
        var isCompleted: Bool
        /// Id for the Identifiable conformance.
        let id = UUID()
    }
    ...
    /// The number of seconds until all the attendees have had a turn to speak.
    ...
    /**
     Initialized a new timer. Initializing a time with no arguments creates a ScrumTime with no attendees and zero length.
